...
class KarirController extends Controller
{
    ...
    public function index(Karir $karir)
    {
        ...
        return view('/dashboard/karir/index', [
    ...
    {
        return view('/dashboard/karir/create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/dashboard/karir')->with('success', 'Data telah berhasil ditambahkan');
    }
    ...
    {
        Gate::authorize('admin', $karir);
        return view('/dashboard/karir/show', [
            'karir' => $karir
        ]);
    }
    ...
    {
        Gate::authorize('admin', $karir);
        return view('/dashboard/karir/edit', [
            'karir' => $karir
        ]);
    }
    ...
    public function update(Request $request, Karir $karir)
    {
        ...
        return redirect('/dashboard/karir')->with('update', 'Data berhasil diubah');
    }
    ...
    public function destroy(Karir $karir)
    {
        ...
        return redirect('/dashboard/karir')->with('success', 'Data berhasil dihapus');
    }
}
