...
class OfficerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/officer/create')->with('success', 'Data yang anda kirim berhasil tersimpan ke dalam database kami, Good Luck!!');
    }
    ...
    public function update(Request $request, Officer $officer)
    {
        ...
        return redirect('/officer')->with('update', 'Data berhasil diubah');
    }
