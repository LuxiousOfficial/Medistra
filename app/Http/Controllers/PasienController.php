...
class PasienController extends Controller
{
    ...
    {
        Gate::authorize('admin', $pasien);
        return view('/dashboard/pasien/index', [
            'pasiens' => Pasien::latest('id')->get()
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/dashboard/pasien')->with('success', 'Anda berhasil melakukan booking dokter sesuai dengan jadwal yang anda tentukan');
    }
    ...
    public function update(Request $request, Pasien $pasien)
    {
        ...
        return redirect('/dashboard/pasien')->with('update', 'Data berhasil diubah');
    }
