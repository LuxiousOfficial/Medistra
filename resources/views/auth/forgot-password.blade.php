...
<title>Rs. Medistra || Forgot Password</title>
...
<x-form>
    <section class="form-login">
        <div class="container-fluid h-custom">
          <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col-xl-5 col-lg-6 col-md-9 col-10">
              <img src="img/logo medistra.webp" class="img-fluid" alt="Sample image" style="width: 28rem;">
            </div>
            <div class="col-xl-4 col-lg-6 col-md-8 col-12 offset-xl-1 medistra">
              <form action="/forgot-password" method="post">
                @csrf
                <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                  <h2 class="text-uppercase text-success mb-3 astra">Rs. Medistra</h2>
                </div>
                ...
                <div class="text-center text-lg-start mt-4 pt-2">
                  <button  type="submit" name="forgot" data-mdb-button-init data-mdb-ripple-init class="btn btn-success fw-bold btn-lg w-100" style="padding-left: 1.5rem; padding-right: 1.5rem;">Send Email</button>
                </div>
                <div class="col-xxl-12 col-xl-12 col-md-12 col-12 d-flex justify-content-between align-items-center fs-5">
                    <p class="d-block text-center small fw-bold mt-2 pt-1 mb-0 text-capitalize">belum punya akun? <br>
                      <a href="/registrasi" class="link-success">Registrasi sekarang</a>
                    </p>
                    ...
                    <p class="d-block text-center small fw-bold mt-2 pt-1 mb-0 text-capitalize">sudah punya akun? <br>
                      <a href="/login" class="link-success">Login Sekarang</a>
                    </p>
                </div>
                @if($errors->any())
        ...
        <div
          class="text-center justify-content-center py-3 px-3 px-xl-5 bg-success">
          <!-- Copyright -->
          <div class="text-white text-capitalize fw-bold fs-6">
           <p> &copy; Copyright 2025 Rs. Medistra All rights reserved by rommy ardiansyah</p>
          </div>
          <!-- Copyright -->
        </div>
      </section>
