<x-layoutdashboardahm>
    @if (session()->has('success'))
     ...
     <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      <h1 class="fs-3 fw-bold text-warning text-capitalize">Data Users</h1>
    </div>

    <section class="bg-white rounded-3 p-4">
      <div class="row">
        <div class="col-md-8 col-10">
          <a href="/dashboard/user/create" class="btn btn-warning mb-3 fw-bold">Tambah User</a>
        </div>
      </div>
      ...
      <div class="table-responsive col-xxl-12 col-xl-12 col-md-12 col-12 small">
        <table class="table table-sm">
          ...
          <tr class="text-center text-black fw-bold">
            ...
            <td class="d-flex">
              <a href="/dashboard/user/{{ $user->id }}" class="btn bg-info px-3 fw-bold border-0 text-white">Details</a>
              <a href="/dashboard/user/{{ $user->id }}/edit" class="btn bg-warning px-3 fw-bold border-0 mx-2 text-white">Edit</a>
