                    ...
                    <form action="/dashboard/user/{{ $user->id }}" method="post">
                      ...
                      @csrf
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                          ...
                          <input type="number" id="is_admin" name="is_admin" class="form-control form-control-lg @error('is_admin')is-invalid @enderror" placeholder="Ketik status anda..." required value="{{ old('is_admin', $user->is_admin) }}"/>
                          @error('is_admin')
                          <div class="invalid-feedback">{{ $message }}</div>
                          @enderror
                        </div>
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                          ...
                          <input type="number" id="is_developer" name="is_developer" class="form-control form-control-lg @error('is_developer')is-invalid @enderror" placeholder="Ketik status anda..." required value="{{ old('is_developer', $user->is_developer) }}"/>
                          @error('is_developer')
                          <div class="invalid-feedback">{{ $message }}</div>
                          @enderror
                        </div>
