<x-layoutdashboardahm>
  <div class="my-3 border-bottom">
    <h1 class="fs-3 fw-bold text-success text-center text-capitalize judul">Biodata Karyawan</h1>
  </div>
              ...
              <div class="col-md-12 col-12">
                ...
                <div class="table-responsive col-xxl-12 col-xl-12 col-md-12 col-sm-12 col-12 small">
                  ...
                  <div class="daftar text-center text-capitalize mt-5">
                    <a href="/dashboard/officer" class="fs-5 fw-bold text-decoration-none py-3 px-3 bg-warning text-uppercase text-white rounded">Back</a>
                  </div>
              </div>
          </div>
      </div>
