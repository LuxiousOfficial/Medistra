<aside class="sidenav navbar navbar-vertical navbar-expand-xs bg-white border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="/dashboard" target="_blank">
        <span class="ms-5 fw-bold">RS. Medistra</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="/dashboard/pasien">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Online Registration</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="/dashboard/karir">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1 fw-bold">Careers</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="/dashboard/officer">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    @endcan
    <div class="sidenav-footer" style="margin-top: -1.7rem;">
      <ul class="navbar-nav">
        <li class="nav-item">
          <form action="/logout" method="post">
            ...
            <a class="nav-link active">
              ...
              <button type="submit" class="nav-link fw-bold" style="margin-left: 0rem">Logout</button>
            </a>
          </form>
        </li>
      </ul>
