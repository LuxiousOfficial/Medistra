    ...
    <section>
       <div class="container-fluid">
         ...
         <div class="my-3 border-bottom">
           ...
           <a href="/dokter/dr_ihza/create" class="btn btn-success mb-3 fw-bold">Tambah Pasien</a>
               ...
               <table class="table table-sm">
                 ...
                 <tbody>
                   ...
                   <tr>
                       ...
                       <td>{{ $pasien->jadwal }}</td>
                       <td class="d-flex">
                         <a href="/dokter/dr_ihza/{{ $pasien->id }}" class="btn btn-info px-3 fw-bold border-0">Details</a>
                         <a href="/dokter/dr_ihza/{{ $pasien->id }}/edit" class="btn btn-warning px-3 fw-bold border-0 mx-2">Edit</a>
                         <form method="post" action="/dokter/dr_ihza/{{ $pasien->id }}">
                           @method('delete')
                           @csrf
